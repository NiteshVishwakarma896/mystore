    ...
    return (
      <ScrollView style={{flex:1}}>
        ...
        <View style={{width:'100%',backgroundColor:'#fff',flexDirection:'row',alignItems:'center',justifyContent:'space-around',padding:'4%'}}>
            <TouchableOpacity onPress={()=>{ navigation.navigate('OrderHistoryScreen'); }} style={{flexDirection:'row',alignItems:'center'}}>
            ...
            <TouchableOpacity onPress={()=>{ navigation.navigate('WishlistScreen'); }}  style={{flexDirection:'row',alignItems:'center'}}>
            ...
            <TouchableOpacity onPress={()=>{ navigation.navigate('DealsScreen'); }} style={{flexDirection:'row',alignItems:'center'}}>
        ...
        <View style={{width:'100%',marginTop:'2%'}}>
          <TouchableOpacity onPress={()=>{ navigation.navigate('OrderHistoryScreen'); }}   style={{width:'100%',flexDirection:'row',alignItems:'center',justifyContent:'space-between',paddingVertical:'3%',paddingHorizontal:'4%',backgroundColor:'#fff'}}>
          ...
          <TouchableOpacity onPress={()=>{ navigation.navigate('WishlistScreen'); }}  style={{width:'100%',flexDirection:'row',alignItems:'center',justifyContent:'space-between',paddingVertical:'3%',paddingHorizontal:'4%',backgroundColor:'#fff'}}>
          ...
          <TouchableOpacity onPress={()=>{ navigation.navigate('DAddressScreen'); }}  style={{width:'100%',flexDirection:'row',alignItems:'center',justifyContent:'space-between',paddingVertical:'3%',paddingHorizontal:'4%',backgroundColor:'#fff'}}>
          ...
          <TouchableOpacity onPress={()=>{ navigation.navigate('NotificationScreen'); }}  style={{width:'100%',flexDirection:'row',alignItems:'center',justifyContent:'space-between',paddingVertical:'3%',paddingHorizontal:'4%',backgroundColor:'#fff'}}>
          ...
          <TouchableOpacity onPress={()=>{ navigation.navigate('PolicyScreen',{type:'24/7 Help & Support'}); }}  style={{width:'100%',flexDirection:'row',alignItems:'center',justifyContent:'space-between',paddingVertical:'3%',paddingHorizontal:'4%',backgroundColor:'#fff'}}>
              <Text style={{fontFamily:'Montserrat-Medium',fontSize:14,color:'#000'}}><Feather name="help-circle" color={'#000'} size={18} />{'   '}Helps</Text>
              <FontAwesome name="angle-right" size={24} color={'#000'} />
          </TouchableOpacity>
          <TouchableOpacity onPress={()=>{ navigation.navigate('ContactUScreen'); }}   style={{width:'100%',flexDirection:'row',alignItems:'center',justifyContent:'space-between',paddingVertical:'3%',paddingHorizontal:'4%',backgroundColor:'#fff'}}>
