...
export default function ProductCardGeneral(props) {
  const navigation = useNavigation();
  return (
    <TouchableOpacity onPress={()=>navigation.navigate('ProductDetails')} style={{width:'48%', margin:4, marginBottom:'8%'}}>
        ...
        <Text numberOfLines={2} style={{fontFamily:'Montserrat-Regular',fontSize:12,marginVertical:'4%',color:'#000'}}>
            {props.description}
        </Text>
